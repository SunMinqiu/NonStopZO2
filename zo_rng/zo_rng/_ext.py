...
def _generate_normal(seed, counter, n, device_str):
    ...
    if _has_native:
        ...
        if want_cuda and not _has_native_cuda:
            ...
            result = _generate_normal_native(seed, counter, n, 'cpu')
        ...
        return _generate_normal_native(seed, counter, n, device_str)

    # No native extension — fall back to pure-Python reference
